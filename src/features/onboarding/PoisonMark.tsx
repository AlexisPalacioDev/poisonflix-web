...
// re-draw of both.
//
// The two variants are SIBLINGS, not the same drawing recoloured: they share
// the flat contour, the accent rim, the fang rows and the tongue, but each keeps
...
// An earlier pass reused one silhouette for both and the cassette just read as
// a green clapper - the silhouette IS the recognition, it cannot be shared.
//
